    ...
    <>
     ...
     >
      ...
      <div className="md:flex block">
        <motion.div className="md:w-[50%] h-[70vh] sm:w-[400px] sm:mx-auto md:mx-0 pl-10 pe-10 "
         initial={{ opacity: 0 }}
         whileInView={{ opacity: 1 }}
         transition={{duration:1}}
        >
        ...
        >
          ...
          <div className="flex gap-5 mb-3 pl-5">
            <div>E-mail</div>
            <div>:</div>
            <div className='textWrap w-[200px] sm:w-full'>sonusharma30.09.2004@gmail.com</div>
          </div>
          <div className="flex gap-5 mb-3 pl-5">
            <div>Freelance</div>
            <div>:</div>
